...
write('MediaUpload.dc.html', screen(
  ...
  body(
    ...
    card(rule_line('image', 'รูป ย่อให้อัตโนมัติ ใบละไม่เกิน 5 MB'),
         rule_line('play', 'วิดีโอ ยาวไม่เกิน 30 วินาที และไม่เกิน 500 MB ต่อคลิป'),
...
write('MediaLimit.dc.html', screen(
  ...
  body(
    ...
    pick_video('IMG_4835.mov', '0:22', '', err='ใหญ่เกิน 500 MB'),
...
1) เพดานคลิป — 30 วินาที / 500 MB ต่อคลิป (ตกลงแล้ว 9 ก.ย. 2569)
   ⚠️ ที่ 500 MB เต็มโควตารวม 5 GB ได้ภายใน 10 คลิป
      โควตารายครอบครัวจึงเป็นเงื่อนไขก่อนเปิดให้คนนอกใช้
