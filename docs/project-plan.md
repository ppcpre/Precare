...
|---|---|---|
| **จับเวลาการบีบตัวของมดลูก** | โครงเดียวกับนับลูกดิ้นเกือบทั้งหมด — `tracking_sessions` รองรับไว้แล้วผ่านคอลัมน์ `kind` และ `events` ที่เป็น JSON จึงไม่ต้อง migrate | ต่ำ ถ้าทำต่อจากนับลูกดิ้น |
