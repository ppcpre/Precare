...
**ยังเหลือ: วิดีโอ** เครื่องเล่นยิงคำขอพร้อมกันหลายเส้น ทำให้ปลุก isolate ใหม่
ซึ่งเป็นส่วนที่กิน CPU 200-250 ms — ตัวเส้นทางไฟล์เองกินแค่ 1-2 ms
แก้จริงต้องแยกเป็น Worker เล็กต่างหาก + signed URL หรือขึ้นแพลน
