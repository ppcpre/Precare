...
**ขั้นถัดไป (ขั้นที่ 3 ตามที่ตกลง): Web Push**
ต้องมี VAPID keys ซึ่งเจ้าของบัญชีเป็นคนสร้างและตั้งเป็น secret เอง
(ขั้นที่ 2 service worker ข้ามไปก่อนตามที่ตกลง)
