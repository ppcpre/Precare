...
**รับเฉพาะ mp4** iPhone ถ่ายเป็น .mov (`video/quicktime`) ซึ่ง Android หลายรุ่น
เปิดไม่ได้ ในแอปที่คนในครอบครัวดูของกันและกัน ไฟล์ที่คนถ่ายเปิดได้แต่คนอื่นเปิดไม่ได้
แย่กว่าการปฏิเสธตั้งแต่แรกพร้อมบอกวิธีตั้งกล้อง
